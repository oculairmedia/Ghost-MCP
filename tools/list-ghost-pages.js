/**
 * Tool handler for listing pages from Ghost blog with pagination and filtering options
 */
import { createApiClient, buildApiUrl, formatErrorResponse, formatSuccessResponse } from '../core/api-client.js';

export async function handleListGhostPages(server, args) {
    try {
        // Set default values
        ...
        try {
            ...
            // Build API URL
            const url = buildApiUrl(apiUrl, 'pages');
...
/**
 * Tool definition for list_ghost_pages
 */
export const listGhostPagesToolDefinition = {
